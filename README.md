...
I'm passionate about open-source 🐍. I'm currently (since Oct 2025) helping out with maintenance of [nanochat](https://github.com/karpathy/nanochat) and I've been involved with maintaining [Typer](https://github.com/tiangolo/typer) and [FastAPI](https://github.com/fastapi/fastapi) since 2024. In the past, I've written open-source software back at Uni, and in 2019-2023 I've been a core maintainer of the NLP library [spaCy](https://github.com/explosion/spaCy), its deep learning library [Thinc](https://github.com/explosion/thinc), and various other repo's in the same 💥 ecosystem. An interview with Once a Maintainer about my journey into open-source can be found [here](https://onceamaintainer.substack.com/p/once-a-maintainer-sofie-van-landeghem).
